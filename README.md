...
Загрузка происходит инкрементально, с записью дат успешных выгрузок во вспомогательную таблицу ods.load_settings в той же транзакции, что и выгрузка.
...
Загрузка происходит инкрементально, с записью дат успешных выгрузок во вспомогательную таблицу dds.load_settings в той же транзакции, что и выгрузка.
При обновлении объекта данные перезаписываются (UPSERT).
