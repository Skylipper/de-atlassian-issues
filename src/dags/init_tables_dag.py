...
def init_tables_dag():
    ...
    init_cdm_click_info = SQLExecuteQueryOperator(
        task_id="init_cdm_issues_info",
        conn_id=var.CLICK_CONNECTION_NAME,
        sql="cdm/init_issues_info.sql",
        autocommit=True
    )
    ...
    init_dds_f_issues >> [init_dds_f_issue_component_values, init_dds_f_issue_version_values,
                          init_dds_f_issue_fix_version_values] >> init_cdm_mv_issues_info >> init_cdm_click_info
