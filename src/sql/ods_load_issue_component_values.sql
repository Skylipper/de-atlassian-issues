...
SELECT object_id                                                                                    as issue_id,
       object_value::jsonb -> 'fields' -> 'project' ->> 'id'                                        as project_id,
       jsonb_array_elements_text(object_value::jsonb -> 'fields' -> 'components')::jsonb ->> 'id'   as component_id,
       jsonb_array_elements_text(object_value::jsonb -> 'fields' -> 'components')::jsonb ->> 'name' as component_name
FROM stg.issues
