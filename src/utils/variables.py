...
JQL_BATCH_SIZE = 100 # Не ставить слишком мало, в JQL поиске есть округление до минут. Если изменений в минуту будет больше, чем количество в пачке, скрипт будет обрабатывать одни те же значения.
