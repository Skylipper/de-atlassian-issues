...
JQL_BATCH_SIZE = 10 # Не ставить слишком мало, в JQL поиске есть округление до минут. Если изменений в минуту будет больше, чем количество в пачке, скрипт будетт обрабатывать одни те же значения.
